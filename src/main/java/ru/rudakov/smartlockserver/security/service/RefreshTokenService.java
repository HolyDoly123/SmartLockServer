package ru.rudakov.smartlockserver.security.service;
...
import ru.rudakov.smartlockserver.repository.RefreshTokenRepository;
...
public class RefreshTokenService {
    @Value("${rudakov.app.jwtRefreshExpirationMs}")
